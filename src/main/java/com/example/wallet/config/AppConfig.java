...
public class AppConfig implements WebMvcConfigurer {
    private final AccountDetailsRepository accountDteailsRepository;

    public AppConfig(AccountDetailsRepository accountDteailsRepository) {
        this.accountDteailsRepository = accountDteailsRepository;
    }

    @Bean
    UserDetailsService userDetailsService() {
        // how to retrieve the user using the UserRepository that is injected
        return nationalID -> accountDteailsRepository.findByAccount_NationalId(nationalID)
